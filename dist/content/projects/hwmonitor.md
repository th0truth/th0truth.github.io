...
Lightweight hardware discovery and monitoring CLI for Linux in pure C, reading hardware data directly from `/sys` and `/proc` instead of shelling out to tools like `lspci`, `dmidecode`, or `lshw`.
